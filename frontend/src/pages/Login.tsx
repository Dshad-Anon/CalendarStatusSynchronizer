...
export const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      const authUrl = await oauthService.getGoogleLoginAuthUrl();
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 transition-colors"
            disabled={loading}
          >
